...
url="https://github.com/cbeuw/Cloak/releases/download/v2.0.0/ck-server-linux-$arch-2.0.0"
urlc="https://github.com/cbeuw/Cloak/releases/download/v2.0.0/ck-client-linux-$arch-2.0.0"
